...
def main():
    ...
    with sm:
        ...
        # TODO：Add orders to roslaunch Yolo, WavingPersonLocalizer and WavingHandDetector nodes
        ...
        smach.StateMachine.add('NAV_TO_BAR', NavigateToWaypoint('bar_table_position'),
                       transitions={'succeeded': 'NAV_TO_SAVED_PERSON',
                            'failed': 'TASK_FAILED'})
        #####################################################################################
        # TODO: All the grasping states including picking two objects and placing them on the tray. In the end, pick up the tray with both objects on it.
        #####################################################################################
        ...
        #####################################################################################
        # TODO: Ask customer to take the objects from the tray.
        #####################################################################################
